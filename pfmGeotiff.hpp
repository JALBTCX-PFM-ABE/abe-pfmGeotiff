...
public:
  ...
  pfmGeotiff (int32_t *argc = 0, char **argv = 0, QWidget *parent = 0);
  ~pfmGeotiff ();
...
protected:
  ...
  void load_arrays (int32_t layer_type, int32_t count, PFM_OPEN_ARGS *open_args, BIN_RECORD bin_record[], float data[]);
